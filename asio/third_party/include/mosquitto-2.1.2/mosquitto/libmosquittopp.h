...
mosqpp_EXPORT int topic_matches_sub_with_pattern(
    const char *sub, const char *topic, const char *clientid, const char *username, bool *result);
mosqpp_EXPORT int sub_matches_acl(const char *acl, const char *sub, bool *result);
mosqpp_EXPORT int sub_matches_acl_with_pattern(
    const char *acl, const char *sub, const char *clientid, const char *username, bool *result);
...
mosqpp_EXPORT int subscribe_callback(int (*callback)(struct mosquitto *,
                                                     void *,
...
public:
    ...
    int socket();
    int will_set(const char *topic,
                 int payloadlen = 0,
                 const void *payload = NULL,
                 int qos = 0,
                 bool retain = false);
    int will_set_v5(const char *topic,
                    int payloadlen = 0,
                    const void *payload = NULL,
                    int qos = 0,
                    bool retain = false,
    ...
    int connect_v5(const char *host,
                   int port,
                   int keepalive,
    ...
    int ext_auth_continue(const char *auth_method,
                          uint16_t auth_data_len = 0,
                          const void *auth_data = NULL,
                          const mosquitto_property *properties = NULL);
    ...
    int socks5_set(const char *host,
                   int port = 1080,
                   const char *username = NULL,
                   const char *password = NULL);
    ...
    virtual void MOSQ_USED on_connect_v5(int /*rc*/,
                                         int /*flags*/,
    ...
    virtual void MOSQ_USED on_publish_v5(int /*mid*/,
                                         int /*reason_code*/,
                                         const mosquitto_property * /*props*/)
    {
        return;
    ...
    virtual void MOSQ_USED on_message_v5(const struct mosquitto_message * /*message*/,
                                         const mosquitto_property * /*props*/)
    {
        return;
    }
    ...
    virtual void MOSQ_USED on_subscribe_v5(int /*mid*/,
                                           int /*qos_count*/,
    ...
    virtual int MOSQ_USED on_ext_auth(const char * /*auth_method*/,
